            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped" id="subsectionTable" border="1">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
                                ...
                                @foreach ($subsections as $subsection)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <form action="{{ route('subsections.destroy', $subsection->id) }}" method="POST"
            ...
            <script>
                ...
                $('form').submit(function(event) {
                    ...
                    swal({
                        ...
                        text: "Subsection ini akan dihapus secara permanen dan tidak dapat dipulihkan.",
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                    }).then((willDelete) => {
